...
avgrep_flow_lr() {
dev=0
ename=flowv2-resnet-avgrep-fs2-lr1e-4
a="CUDA_VISIBLE_DEVICES=$dev python -u $(pwd)/train.py --loss l1 --weight-ds 0 --weight-ofs 2 --flow-sm-alpha 150 --stack-flows --multi-flow -b 8 --epoch 15 -l 1e-4 --rec-mode flow --rep-cons --softmin-beta 0 --weight-ec 0 --weight-dc 0 --weight-fc 0 --weight-sc 0 --weight-pl 0 --log ${DATADIR}/$ename &>$(pwd)/log/$ename.txt --config-file $(pwd)/misc/tartanair.cfg"

ename=flowv2-resnet-avgrep-fs2-lr5e-5
b="CUDA_VISIBLE_DEVICES=$dev python -u $(pwd)/train.py --loss l1 --weight-ds 0 --weight-ofs 2 --flow-sm-alpha 150 --stack-flows --multi-flow -b 8 --epoch 15 -l 5e-5 --rec-mode flow --rep-cons --softmin-beta 0 --weight-ec 0 --weight-dc 0 --weight-fc 0 --weight-sc 0 --weight-pl 0 --log ${DATADIR}/$ename &>$(pwd)/log/$ename.txt --config-file $(pwd)/misc/tartanair.cfg"

ename=flowv2-resnet-avgrep-fs2-lr1e-5
c="CUDA_VISIBLE_DEVICES=$dev python -u $(pwd)/train.py --loss l1 --weight-ds 0 --weight-ofs 2 --flow-sm-alpha 150 --stack-flows --multi-flow -b 8 --epoch 15 -l 1e-5 --rec-mode flow --rep-cons --softmin-beta 0 --weight-ec 0 --weight-dc 0 --weight-fc 0 --weight-sc 0 --weight-pl 0 --log ${DATADIR}/$ename &>$(pwd)/log/$ename.txt --config-file $(pwd)/misc/tartanair.cfg"
